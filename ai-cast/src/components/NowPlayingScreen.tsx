export function NowPlayingScreen() {
  return (
    <div className="flex flex-1 flex-col px-5 py-4">
      <div className="mb-4 text-center text-[11px] font-semibold tracking-[0.04em] text-[var(--color-w3)]">
        再生中
      </div>
      <div className="mb-5 flex aspect-square w-full flex-col items-center justify-center gap-1 rounded-[14px]" style={{ background: 'linear-gradient(135deg, #2d1b69 0%, #7c3aed 40%, #c026d3 70%, #e11d9b 100%)' }}>
      ...
      <div className="mb-4 text-center text-[11px] text-[var(--color-purple)]">
        aicast · 5分
      </div>
      ...
      <div className="mb-3 flex justify-between text-[9px] text-[var(--color-w3)]">
        <span>1:42</span>
        <span>-3:18</span>
      </div>
